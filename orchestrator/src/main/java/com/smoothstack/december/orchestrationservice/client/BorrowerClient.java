...
// void checkOutBook(@RequestParam("bookId") long bookId,
// @RequestParam("branchId") long branchId,
// @RequestParam("borrowerId") long borrowerId);

// @PostMapping("/checkin")
// void checkInBook(@RequestParam("bookId") long bookId,
// @RequestParam("branchId") long branchId,
// @RequestParam("borrowerId") long borrowerId);
...
// public List<Book> getAvailableBooksNotCheckedOut(@PathVariable("branchId")
// long branchId,
// @RequestParam("borrowerId") long borrowerId);
